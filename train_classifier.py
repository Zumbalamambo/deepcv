...
def _configure_optimizer(learning_rate):
    ...
    if FLAGS.optimizer == 'adadelta':
        ...
        optimizer = tf.train.AdamOptimizer(learning_rate, beta1=FLAGS.adam_beta1, beta2=FLAGS.adam_beta2,
        ...
        optimizer = tf.train.RMSPropOptimizer(learning_rate, decay=FLAGS.rmsprop_decay, momentum=FLAGS.momentum,
                                              epsilon=FLAGS.opt_epsilon)
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        # Select the network #
        ######################
        network_fn = classifier_factory.get_network_fn(FLAGS.model_name,
