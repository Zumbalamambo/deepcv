...
def inception_v2_base(inputs,
    ...
    with tf.variable_scope(scope, 'InceptionV2', [inputs]):
        with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d, slim.separable_conv2d],
...
def reduced_kernel_size_for_small_input(input_tensor, kernel_size):
    return _reduced_kernel_size_for_small_input(input_tensor, kernel_size)
...
inception_v2_arg_scope = inception_util.inception_arg_scope
