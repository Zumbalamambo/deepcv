...
# source: model/detection/protos/optimizer.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='model/detection/protos/optimizer.proto',
  package='model.detection.protos',
  serialized_pb=_b('\n&model/detection/protos/optimizer.proto\x12\x16model.detection.protos\"\xb2\x02\n\tOptimizer\x12\x46\n\x12rms_prop_optimizer\x18\x01 \x01(\x0b\x32(.model.detection.protos.RMSPropOptimizerH\x00\x12G\n\x12momentum_optimizer\x18\x02 \x01(\x0b\x32).model.detection.protos.MomentumOptimizerH\x00\x12?\n\x0e\x61\x64\x61m_optimizer\x18\x03 \x01(\x0b\x32%.model.detection.protos.AdamOptimizerH\x00\x12 \n\x12use_moving_average\x18\x04 \x01(\x08:\x04true\x12$\n\x14moving_average_decay\x18\x05 \x01(\x02:\x06\x30.9999B\x0b\n\toptimizer\"\x9e\x01\n\x10RMSPropOptimizer\x12;\n\rlearning_rate\x18\x01 \x01(\x0b\x32$.model.detection.protos.LearningRate\x12%\n\x18momentum_optimizer_value\x18\x02 \x01(\x02:\x03\x30.9\x12\x12\n\x05\x64\x65\x63\x61y\x18\x03 \x01(\x02:\x03\x30.9\x12\x12\n\x07\x65psilon\x18\x04 \x01(\x02:\x01\x31\"w\n\x11MomentumOptimizer\x12;\n\rlearning_rate\x18\x01 \x01(\x0b\x32$.model.detection.protos.LearningRate\x12%\n\x18momentum_optimizer_value\x18\x02 \x01(\x02:\x03\x30.9\"L\n\rAdamOptimizer\x12;\n\rlearning_rate\x18\x01 \x01(\x0b\x32$.model.detection.protos.LearningRate\"\xa5\x02\n\x0cLearningRate\x12N\n\x16\x63onstant_learning_rate\x18\x01 \x01(\x0b\x32,.model.detection.protos.ConstantLearningRateH\x00\x12_\n\x1f\x65xponential_decay_learning_rate\x18\x02 \x01(\x0b\x32\x34.model.detection.protos.ExponentialDecayLearningRateH\x00\x12S\n\x19manual_step_learning_rate\x18\x03 \x01(\x0b\x32..model.detection.protos.ManualStepLearningRateH\x00\x42\x0f\n\rlearning_rate\"4\n\x14\x43onstantLearningRate\x12\x1c\n\rlearning_rate\x18\x01 \x01(\x02:\x05\x30.002\"\x97\x01\n\x1c\x45xponentialDecayLearningRate\x12$\n\x15initial_learning_rate\x18\x01 \x01(\x02:\x05\x30.002\x12\x1c\n\x0b\x64\x65\x63\x61y_steps\x18\x02 \x01(\r:\x07\x34\x30\x30\x30\x30\x30\x30\x12\x1a\n\x0c\x64\x65\x63\x61y_factor\x18\x03 \x01(\x02:\x04\x30.95\x12\x17\n\tstaircase\x18\x04 \x01(\x08:\x04true\"\xd9\x01\n\x16ManualStepLearningRate\x12$\n\x15initial_learning_rate\x18\x01 \x01(\x02:\x05\x30.002\x12U\n\x08schedule\x18\x02 \x03(\x0b\x32\x43.model.detection.protos.ManualStepLearningRate.LearningRateSchedule\x1a\x42\n\x14LearningRateSchedule\x12\x0c\n\x04step\x18\x01 \x01(\r\x12\x1c\n\rlearning_rate\x18\x02 \x01(\x02:\x05\x30.002')
)
...
_OPTIMIZER = _descriptor.Descriptor(
  name='Optimizer',
  full_name='model.detection.protos.Optimizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='rms_prop_optimizer', full_name='model.detection.protos.Optimizer.rms_prop_optimizer', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='momentum_optimizer', full_name='model.detection.protos.Optimizer.momentum_optimizer', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='adam_optimizer', full_name='model.detection.protos.Optimizer.adam_optimizer', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_moving_average', full_name='model.detection.protos.Optimizer.use_moving_average', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='moving_average_decay', full_name='model.detection.protos.Optimizer.moving_average_decay', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='optimizer', full_name='model.detection.protos.Optimizer.optimizer',
...
_RMSPROPOPTIMIZER = _descriptor.Descriptor(
  ...
  full_name='model.detection.protos.RMSPropOptimizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='model.detection.protos.RMSPropOptimizer.learning_rate', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='momentum_optimizer_value', full_name='model.detection.protos.RMSPropOptimizer.momentum_optimizer_value', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='decay', full_name='model.detection.protos.RMSPropOptimizer.decay', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='epsilon', full_name='model.detection.protos.RMSPropOptimizer.epsilon', index=3,
...
_MOMENTUMOPTIMIZER = _descriptor.Descriptor(
  ...
  full_name='model.detection.protos.MomentumOptimizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='model.detection.protos.MomentumOptimizer.learning_rate', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='momentum_optimizer_value', full_name='model.detection.protos.MomentumOptimizer.momentum_optimizer_value', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=0.9,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADAMOPTIMIZER = _descriptor.Descriptor(
  name='AdamOptimizer',
  full_name='model.detection.protos.AdamOptimizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='model.detection.protos.AdamOptimizer.learning_rate', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LEARNINGRATE = _descriptor.Descriptor(
  name='LearningRate',
  full_name='model.detection.protos.LearningRate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='constant_learning_rate', full_name='model.detection.protos.LearningRate.constant_learning_rate', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='exponential_decay_learning_rate', full_name='model.detection.protos.LearningRate.exponential_decay_learning_rate', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='manual_step_learning_rate', full_name='model.detection.protos.LearningRate.manual_step_learning_rate', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='learning_rate', full_name='model.detection.protos.LearningRate.learning_rate',
      index=0, containing_type=None, fields=[]),
  ],
...
_CONSTANTLEARNINGRATE = _descriptor.Descriptor(
  ...
  full_name='model.detection.protos.ConstantLearningRate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='model.detection.protos.ConstantLearningRate.learning_rate', index=0,
...
_EXPONENTIALDECAYLEARNINGRATE = _descriptor.Descriptor(
  ...
  full_name='model.detection.protos.ExponentialDecayLearningRate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='initial_learning_rate', full_name='model.detection.protos.ExponentialDecayLearningRate.initial_learning_rate', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=0.002,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='decay_steps', full_name='model.detection.protos.ExponentialDecayLearningRate.decay_steps', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='decay_factor', full_name='model.detection.protos.ExponentialDecayLearningRate.decay_factor', index=2,
      number=3, type=2, cpp_type=6, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='staircase', full_name='model.detection.protos.ExponentialDecayLearningRate.staircase', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MANUALSTEPLEARNINGRATE_LEARNINGRATESCHEDULE = _descriptor.Descriptor(
  ...
  full_name='model.detection.protos.ManualStepLearningRate.LearningRateSchedule',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='step', full_name='model.detection.protos.ManualStepLearningRate.LearningRateSchedule.step', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='learning_rate', full_name='model.detection.protos.ManualStepLearningRate.LearningRateSchedule.learning_rate', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=0.002,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MANUALSTEPLEARNINGRATE = _descriptor.Descriptor(
  ...
  full_name='model.detection.protos.ManualStepLearningRate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='initial_learning_rate', full_name='model.detection.protos.ManualStepLearningRate.initial_learning_rate', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=0.002,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='schedule', full_name='model.detection.protos.ManualStepLearningRate.schedule', index=1,
...
Optimizer = _reflection.GeneratedProtocolMessageType('Optimizer', (_message.Message,), dict(
  ...
  __module__ = 'model.detection.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:model.detection.protos.Optimizer)
  ))
...
RMSPropOptimizer = _reflection.GeneratedProtocolMessageType('RMSPropOptimizer', (_message.Message,), dict(
  ...
  __module__ = 'model.detection.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:model.detection.protos.RMSPropOptimizer)
  ))
...
MomentumOptimizer = _reflection.GeneratedProtocolMessageType('MomentumOptimizer', (_message.Message,), dict(
  ...
  __module__ = 'model.detection.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:model.detection.protos.MomentumOptimizer)
  ))
...
AdamOptimizer = _reflection.GeneratedProtocolMessageType('AdamOptimizer', (_message.Message,), dict(
  ...
  __module__ = 'model.detection.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:model.detection.protos.AdamOptimizer)
  ))
...
LearningRate = _reflection.GeneratedProtocolMessageType('LearningRate', (_message.Message,), dict(
  ...
  __module__ = 'model.detection.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:model.detection.protos.LearningRate)
  ))
...
ConstantLearningRate = _reflection.GeneratedProtocolMessageType('ConstantLearningRate', (_message.Message,), dict(
  ...
  __module__ = 'model.detection.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:model.detection.protos.ConstantLearningRate)
  ))
...
ExponentialDecayLearningRate = _reflection.GeneratedProtocolMessageType('ExponentialDecayLearningRate', (_message.Message,), dict(
  ...
  __module__ = 'model.detection.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:model.detection.protos.ExponentialDecayLearningRate)
  ))
...
ManualStepLearningRate = _reflection.GeneratedProtocolMessageType('ManualStepLearningRate', (_message.Message,), dict(
  ...
  LearningRateSchedule = _reflection.GeneratedProtocolMessageType('LearningRateSchedule', (_message.Message,), dict(
    ...
    __module__ = 'model.detection.protos.optimizer_pb2'
    # @@protoc_insertion_point(class_scope:model.detection.protos.ManualStepLearningRate.LearningRateSchedule)
    ))
  ,
  DESCRIPTOR = _MANUALSTEPLEARNINGRATE,
  __module__ = 'model.detection.protos.optimizer_pb2'
  # @@protoc_insertion_point(class_scope:model.detection.protos.ManualStepLearningRate)
  ))
