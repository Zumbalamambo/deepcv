...
# source: model/detection/protos/region_similarity_calculator.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='model/detection/protos/region_similarity_calculator.proto',
  package='model.detection.protos',
  serialized_pb=_b('\n9model/detection/protos/region_similarity_calculator.proto\x12\x16model.detection.protos\"\x82\x02\n\x1aRegionSimilarityCalculator\x12M\n\x16neg_sq_dist_similarity\x18\x01 \x01(\x0b\x32+.model.detection.protos.NegSqDistSimilarityH\x00\x12?\n\x0eiou_similarity\x18\x02 \x01(\x0b\x32%.model.detection.protos.IouSimilarityH\x00\x12?\n\x0eioa_similarity\x18\x03 \x01(\x0b\x32%.model.detection.protos.IoaSimilarityH\x00\x42\x13\n\x11region_similarity\"\x15\n\x13NegSqDistSimilarity\"\x0f\n\rIouSimilarity\"\x0f\n\rIoaSimilarity')
)
...
_REGIONSIMILARITYCALCULATOR = _descriptor.Descriptor(
  ...
  full_name='model.detection.protos.RegionSimilarityCalculator',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='neg_sq_dist_similarity', full_name='model.detection.protos.RegionSimilarityCalculator.neg_sq_dist_similarity', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='iou_similarity', full_name='model.detection.protos.RegionSimilarityCalculator.iou_similarity', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ioa_similarity', full_name='model.detection.protos.RegionSimilarityCalculator.ioa_similarity', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='region_similarity', full_name='model.detection.protos.RegionSimilarityCalculator.region_similarity',
...
_NEGSQDISTSIMILARITY = _descriptor.Descriptor(
  ...
  full_name='model.detection.protos.NegSqDistSimilarity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_IOUSIMILARITY = _descriptor.Descriptor(
  name='IouSimilarity',
  full_name='model.detection.protos.IouSimilarity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_IOASIMILARITY = _descriptor.Descriptor(
  name='IoaSimilarity',
  full_name='model.detection.protos.IoaSimilarity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
RegionSimilarityCalculator = _reflection.GeneratedProtocolMessageType('RegionSimilarityCalculator', (_message.Message,), dict(
  ...
  __module__ = 'model.detection.protos.region_similarity_calculator_pb2'
  # @@protoc_insertion_point(class_scope:model.detection.protos.RegionSimilarityCalculator)
  ))
...
NegSqDistSimilarity = _reflection.GeneratedProtocolMessageType('NegSqDistSimilarity', (_message.Message,), dict(
  ...
  __module__ = 'model.detection.protos.region_similarity_calculator_pb2'
  # @@protoc_insertion_point(class_scope:model.detection.protos.NegSqDistSimilarity)
  ))
...
IouSimilarity = _reflection.GeneratedProtocolMessageType('IouSimilarity', (_message.Message,), dict(
  ...
  __module__ = 'model.detection.protos.region_similarity_calculator_pb2'
  # @@protoc_insertion_point(class_scope:model.detection.protos.IouSimilarity)
  ))
...
IoaSimilarity = _reflection.GeneratedProtocolMessageType('IoaSimilarity', (_message.Message,), dict(
  ...
  __module__ = 'model.detection.protos.region_similarity_calculator_pb2'
  # @@protoc_insertion_point(class_scope:model.detection.protos.IoaSimilarity)
  ))
