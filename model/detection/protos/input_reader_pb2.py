...
# source: model/detection/protos/input_reader.proto
...
_INPUTREADER = _descriptor.Descriptor(
  name='InputReader',
  full_name='model.detection.protos.InputReader',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='label_map_path', full_name='model.detection.protos.InputReader.label_map_path', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='shuffle', full_name='model.detection.protos.InputReader.shuffle', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='queue_capacity', full_name='model.detection.protos.InputReader.queue_capacity', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_after_dequeue', full_name='model.detection.protos.InputReader.min_after_dequeue', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_epochs', full_name='model.detection.protos.InputReader.num_epochs', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_readers', full_name='model.detection.protos.InputReader.num_readers', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='load_instance_masks', full_name='model.detection.protos.InputReader.load_instance_masks', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tf_record_input_reader', full_name='model.detection.protos.InputReader.tf_record_input_reader', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='external_input_reader', full_name='model.detection.protos.InputReader.external_input_reader', index=8,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='input_reader', full_name='model.detection.protos.InputReader.input_reader',
...
_TFRECORDINPUTREADER = _descriptor.Descriptor(
  ...
  full_name='model.detection.protos.TFRecordInputReader',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='input_path', full_name='model.detection.protos.TFRecordInputReader.input_path', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXTERNALINPUTREADER = _descriptor.Descriptor(
  ...
  full_name='model.detection.protos.ExternalInputReader',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
InputReader = _reflection.GeneratedProtocolMessageType('InputReader', (_message.Message,), dict(
  ...
  __module__ = 'model.detection.protos.input_reader_pb2'
  # @@protoc_insertion_point(class_scope:model.detection.protos.InputReader)
  ))
...
TFRecordInputReader = _reflection.GeneratedProtocolMessageType('TFRecordInputReader', (_message.Message,), dict(
  ...
  __module__ = 'model.detection.protos.input_reader_pb2'
  # @@protoc_insertion_point(class_scope:model.detection.protos.TFRecordInputReader)
  ))
...
ExternalInputReader = _reflection.GeneratedProtocolMessageType('ExternalInputReader', (_message.Message,), dict(
  ...
  __module__ = 'model.detection.protos.input_reader_pb2'
  # @@protoc_insertion_point(class_scope:model.detection.protos.ExternalInputReader)
  ))
